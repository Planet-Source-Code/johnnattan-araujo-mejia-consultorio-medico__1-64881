VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} DTHISTORIAL 
   Caption         =   "Proyecto1 - DTHISTORIAL (DataReport)"
   ClientHeight    =   8235
   ClientLeft      =   885
   ClientTop       =   2925
   ClientWidth     =   14580
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item4 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "HISTORIAL MEDICO"
      EndProperty
      ItemType5       =   5
